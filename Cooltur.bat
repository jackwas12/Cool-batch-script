...
if %input%==Toonkid12 goto correct
if not %input%==Toonkid12 goto incorrect
...
echo Enter 4 to start Bruteforce (make sure its installed)  
echo Enter 5 to start Helpmode Bruteforce
echo Enter 6 to start WinRarcracker
echo Enter 7 to exit
set /p anr="Enter Number: "
...
echo Enter 4 to start Fish Game
echo Enter 6 to start Dinosaur Game
echo Enter 5 to exit

set /p anq="Enter Number: "
...
if %anq%%==6 (
start GoogleDinosaur.bat
)

:e 
cls
echo You are at menu 4
echo Enter 4 to go to Calculater
echo Enter 5 to go to AC
echo Enter 6 to exit 
set /p ang="Enter Number: "
...
:choice
set /P ca=Are you sure you want to continue[Y/N]?
if /I "%ca%%" EQU "Y" goto a
if /I "%ca%%" EQU "N" goto c


:choice1
set /P car=Are you sure you want to continue[Y/N]?
if /I "%car%%" EQU "Y" goto b
if /I "%car%%" EQU "N" goto c


:choice2
set /P cay=Are you sure you want to continue[Y/N]?
if /I "%cay%%" EQU "Y" goto e
if /I "%cay%%" EQU "N" goto c
...
echo wouldn't be able to save your game...
pause >nul
goto start1
)
